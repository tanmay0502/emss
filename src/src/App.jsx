...
import RequestList from './pages/issue_request_management/requestlist'
import Issue from './pages/issue_request_management/CreateIssue';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/session/" element={<Routed Session={sessionState} />}>
            ...
            <Route
              path="/session/issuemanagement/registerrequest/"
              element={<Issue />}
            />
