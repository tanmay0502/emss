        ...
        <div class="divh5">
          <div className="blocks hide-scroll-bar rounded-xl">
            ...
            <div className="pl-2 pb-2">
              ...
              <p className="notifs pl-2 pb-4">
                First Randomisation completed in districts- Bhind, Gwalior,
                Indore, Bhopal
              </p>
              <p className="notifs pl-2 pb-2">
                First Level Check completed in districts of Madhya Pradesh
              </p>

              <hr></hr>

              <p className="text-sm pt-2">Past Notifications</p>
              <p className="notifs pl-2 pt-2">
                <span className="text-red-500">Action Required-</span> Request
                Ticket raised by DEO Gwalior regarding movement of units.
              </p>
            </div>
          </div>
        </div>
