...
const Unitcountingdefective = ({ UnitChecked, bgColor, UnitID, data }) => {
            ...
            var data_tmp = data
                ...
                .map((val) => {
                    return {
                        ...
                        "Status Update Time": val["timestamp"] ? val["timestamp"].split('T')[0] : "",
                        "": (
                    ...
                    <table>
                        ...
                        {tableData.length ?
                            tableData.map((val, id) => {
                                ...
                                return (
                                    <>
                                        <tr style={{ backgroundColor: ((UnitID.includes(val['ID'])) ? bgColor : ''), hover: "black" }} onClick={() => { callfunction("Row", val['ID']) }} >
...
export default Unitcountingdefective;
