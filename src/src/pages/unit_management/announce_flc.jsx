...
function Announce_Flc() {
    ...
    console.log(listElections, 'DistrictDistrict')
    ...
    console.log(electionid, 'selectedDistrictssf')
                ...
                >
                    ...
                    {listElections &&
                        listElections.map((val, ind) => {
                            return (<>
                                <option value={ind}>{`${val.electiontype} ${val.startdate.slice(6, 11)}`}</option>
                            </>)
                        })}
                </select>
            </div>
            ...
            <div className='flex justify-between'>
                <form onSubmit={onFormSubmit} id="form" className='w-2/3 m-5'>
                    <div className={styles.Schedule_container}>
                        ...
                        <div className='w-full text-left p-4 mb-1'>
