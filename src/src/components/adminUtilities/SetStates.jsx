...
function SetStates(){
  ...
  async  function deleteState(id){
        console.log(id)
        let body = {
            "state_name": permission[id]["stateName"],
            "state_code": permission[id]["stateCode"],
            "state_orut": permission[id]["stateOrut"],
          }
        try {
            const response = await fetch(
                   ...
                   <><tr>
                    <td colSpan={10}>
                        <div className='flex justify-around'>
                            <div className='w-1/4 font-bold text-left'>State Name</div>
                            <div className='w-1/4 font-bold text-left'>State Code</div>
                            <div className='w-1/4 font-bold text-left'>State Orut</div>
                ...
                <tr>
                    <td colSpan={10}>
                        <div className='flex justify-between hover:bg-orange-500 hover:text-white'>
                            <div className='w-1/3 text-left'>{permission[id]["stateName"]}</div>
                            <div className='w-1/3 text-left'>{permission[id]["stateCode"]}</div>
                            <div className='w-1/3 text-left'>{permission[id]["stateOrut"]}</div>
                            <div className='w-1/3  text-left flex justify-between text-white'>
                                {/* <div className='w-1/3'></div> */}
                                <a className=' text-white ' onClick={()=>deleteState(id)}><img className='text-white  ' width="20" height="20" style={{marginLeft:""}} src={DeleleBtn}></img></a>
                                {/* <div className='w-1/3'></div> */}
